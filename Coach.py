...
class Coach:
    ...
    def learn(self):
        ...
        for i in range(1, self.args.numIters + 1):
            ...
            history_len = len(self.trainExamplesHistory)
            ...
            self.nnet.save_checkpoint(folder=self.args.checkpoint, filename='checkpoint.h5')
            self.pnet.load_checkpoint(folder=self.args.checkpoint, filename='checkpoint.h5')
            ...
            if pwins + nwins == 0 or float(nwins) / (pwins + nwins) < self.args.updateThreshold:
                ...
                self.nnet.load_checkpoint(folder=self.args.checkpoint, filename='checkpoint.h5')
            else:
    ...
    def loadTrainExamples(self):
        ...
        if not os.path.isfile(examplesFile):
            ...
            log.info(f"File with trainExamples found: '{examplesFile}'. Loading it...")
