...
def board_to_array(chess_board: chess.Board):
    turn = str(int(chess_board.turn))
    move_number = str(chess_board.fullmove_number)
    halfmove_number = str(chess_board.halfmove_clock)

    can_1castle_ks = str(int(chess_board.has_kingside_castling_rights(True)))
    can_1castle_qs = str(int(chess_board.has_queenside_castling_rights(True)))
    can_0castle_ks = str(int(chess_board.has_kingside_castling_rights(False)))
    can_0castle_qs = str(int(chess_board.has_kingside_castling_rights(False)))
    ...
    last_line = turn + ","
    last_line = last_line + move_number + ","
    last_line = last_line + halfmove_number + ","
    last_line = last_line + can_1castle_ks + "," + can_1castle_qs + "," + can_0castle_ks + "," + can_0castle_qs + ",0"

    last_line_np = np.array(last_line.split(","), dtype=float)
    board = np.append(board, last_line_np).reshape((9, 8))
    return board
